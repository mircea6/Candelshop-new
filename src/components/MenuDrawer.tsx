...
export default function MenuDrawer({ isOpen, onClose }: MenuDrawerProps) {
    ...
    return (
        <>
            ...
            {/* Drawer (meniul din stânga) - renderizat întotdeauna pentru tranziție */}
            <div
                className={`fixed top-0 left-0 h-full w-80 bg-white shadow-xl z-[60] transform transition-transform duration-300 ease-in-out ${
