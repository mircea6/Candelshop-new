...
const ODORIZANTE: Product[] = [
  {
    id: "lumanare-odorizanta-1",
    name: "Lumânare odorizantă 1",
    price: 35,
    currency: "RON",
    scent: "floral",
    wax: "soia",
    ...
    sizeGrams: 150,
    inStock: true,
    image: "/lumanare-odorizanta1.jpeg",
    description: "Lumânare odorizantă pentru ambient.",
    createdAt: new Date().toISOString(),
  },
  {
    id: "lumanare-odorizanta-2",
    name: "Lumânare odorizantă 2",
    price: 42,
    currency: "RON",
    scent: "citrice",
    wax: "soia",
    ...
    sizeGrams: 180,
    inStock: true,
    image: "/lumanare-odorizanta2.jpeg",
    description: "Lumânare odorizantă pentru ambient.",
    createdAt: new Date().toISOString(),
  },
];
